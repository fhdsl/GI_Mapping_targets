...
#'
#' @param .data Data can be piped in with a tidyverse pipe from function to function.
...
#' The replicates will be kept collapsed to an average.
...
#' @param rm_ids_wo_annot default is TRUE; whether or not to filter out pgRNA IDs
